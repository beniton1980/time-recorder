...
const SUMMARY_BG = "#edf4ee";
const SUMMARY_BORDER = "#c8d6cb";
const SUMMARY_LABEL = "#405449";
...
function drawSummary(command, staff) {
  ...
  fill(command, boxX, boxY, boxWidth, 36, SUMMARY_BORDER);
  values.forEach(([label, value], index) => {
    const x = boxX + index * cellWidth + 0.7;
    fill(command, x, boxY + 0.7, cellWidth - 1.4, 34.6, SUMMARY_BG);
    text(command, x + 8, boxY + 21, label, 6.4, SUMMARY_LABEL, true, {
      width: cellWidth - 16,
      align: "right",
    });
