...
export async function generateStorePosterPdf({ storeName, qrPngDataUrl }) {
  ...
  doc.font("NotoSansJP-Regular").fontSize(10.5).fillColor("#333333")
    .text(`${storeName} の打刻用QRです。\nLINEで読み取って打刻画面を開いてください。`, 102, 370, {
  ...
  doc.font("NotoSansJP-Regular").fontSize(8.5).fillColor("#6b6b6b")
    .text("このQRはこの店舗専用です。", 42, 775, { width: contentWidth, align: "center" });
  doc.font("NotoSansJP-Bold").fontSize(9).fillColor("#20334f")
    .text("ONOGAMI勤怠", 42, 798, { width: contentWidth, align: "center" });
